// src/app/(app)/orcamentos/DeleteQuoteModal.tsx
...
export default function DeleteQuoteModal({ isOpen, onClose, onConfirm, isLoading, orcamento }: DeleteQuoteModalProps) {
          ...
          <div className="mt-0 text-left">
            ...
            <div className="mt-2">
              <p className="text-sm text-gray-500">
                Você tem certeza que deseja excluir o orçamento <strong>#{orcamento.id}</strong>? Esta ação não poderá ser desfeita.
              </p>
            </div>
          </div>
        </div>
