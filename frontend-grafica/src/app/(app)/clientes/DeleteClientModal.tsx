// src/app/(app)/clientes/DeleteClientModal.tsx
...
export default function DeleteClientModal({ isOpen, onClose, onConfirm, isLoading, cliente }: DeleteClientModalProps) {
          ...
          <div className="mt-0 text-left">
            ...
            <div className="mt-2">
              <p className="text-sm text-gray-500">
                Você tem certeza que deseja excluir o cliente <strong>{cliente.nome}</strong>? Esta ação não poderá ser desfeita.
              </p>
            </div>
          </div>
        </div>
